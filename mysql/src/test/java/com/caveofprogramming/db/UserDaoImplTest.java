...
public class UserDaoImplTest {
	...
	public void testFindAndUpdate( ) throws SQLException {
		...
		assertEquals("retrieved user doesn't matched saved user", user, retrievedUser);
		...
		assertEquals("retrieved user doesn't matched updated user", user, retrievedUser);
	...
	@Test
	public void testGelAll() throws SQLException {
		UserDao userDao = new UserDaoImpl();
	...
	public void testSave() throws SQLException {
		...
		assertTrue("cannot retrived inserted user", result);
